...
v_15Hz_arredondar = ((2*dP_15Hz)/densidade_ar)**(1/2)
v_30Hz_arredondar = ((2*dP_30Hz)/densidade_ar)**(1/2)
v_45Hz_arredondar = ((2*dP_45Hz)/densidade_ar)**(1/2)
v_60Hz_arredondar = ((2*dP_60Hz)/densidade_ar)**(1/2)
...
h= dh_15_i #Deflexão do manômetro a H2O em m
...
DELTA_P= rho_água*g*dh_15_i #ALTERAR AQUI PARA TER DIFERENTES VAZÕES
beta= D_t/D_1
rho_ar= densidade_ar
